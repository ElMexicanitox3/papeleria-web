...
<!-- Titulo -->
@section('title', isset($brand) ? 'Editar Marca' : 'Crear Marca')
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m6 offset-m3">
                <form action="{{ isset($brand) ? route('brands.update', $brand->uuid) : route('brands.store') }}" method="POST">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                <div class="col s12 m12">
                                    ...
                                    @csrf
                                    @include('includes.input-field', ['name' => 'name', 'label' => 'Nombre de la marca', 'defaultvalue'=> isset($brand) ? $brand->name : ''])
                                </div>
                            </div>

...
@section('content')
    <div class="section no-pad-bot" id="index-banner">
        <div class="container">
            <br><br>
            <h1 class="header center blue-text">Compara, compra y vende</h1>
            <div class="row center">
                <h5 class="header col s12 light">Empieza con nosotros y descubre el mundo de la competencia en ventas</h5>
            </div>
            <div class="row center">
                <a href="{{ route('home.login') }}" id="download-button"
                    class="btn-large waves-effect waves-light blue">Registrate</a>
            </div>
            <br><br>
        </div>
    </div>

        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <a href="{{ route('home.index') }}" class="flex-shrink-0 text-white">
                        <img class="logo-img" src="{{ asset('images/p-1.png') }}" alt="5">
                    </a>
                </div>
                <div class="hidden sm:block">
                    <a href="{{ route('home.index') }}"class="{{ $linkClasses }}">Inicio</a>
                    <a href="#"class="{{ $linkClasses }}">Acerca de</a>
                    <a href="https://api.whatsapp.com/send?phone=525517283323" target="_blank" class="{{ $linkClasses }}">Contacto</a>
                    <a href="{{ route('home.login') }}" type="button" class="{{ $buttonClasses }}">Iniciar Sesion</a>
                    <a href="{{ route('home.register') }}" type="button" class="{{ $buttonClasses }}">Registrase</a>
                </div>
